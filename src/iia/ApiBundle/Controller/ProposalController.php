...
use iia\ApiBundle\Entity\Proposal;
use iia\ApiBundle\Form\ProposalType;
...
class ProposalController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('iiaApiBundle:Proposal')->findAll();

        return $this->render('iiaApiBundle:Proposal:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('iiaApiBundle:Proposal:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('iiaApiBundle:Proposal')->find($id);
        ...
        return $this->render('iiaApiBundle:Proposal:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('iiaApiBundle:Proposal:edit.html.twig', array(
            'entity'      => $entity,
